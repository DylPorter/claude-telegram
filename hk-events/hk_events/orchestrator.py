...
def _deliver(messages: list[str], board, *, staleness_alarm, drop_notice) -> None:
    ...
    Still ONE notification, in all three shapes:
      ...
      * `HK_EVENTS_BOARD_URL` set — the summary bubble carries a Markdown link
      ...
      * `HK_EVENTS_BOARD_ATTACH` set alone — the FALLBACK, unchanged: the
