...
Copied from signal-brief — small enough that duplication is cheaper than
cross-package import coupling. If the push interface ever drifts, lift this
to a shared module.
"""
...
from job_sift.config import PUSH_DOCUMENT_URL, PUSH_SECRET, PUSH_URL
